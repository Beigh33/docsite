...
description: Learn how to enable and integrate Vercel Web Analytics in your project, including installation, configuration, and viewing analytics data.
---
...
<Tabs>
	<TabItem label="pnpm">```bash pnpm i vercel ```</TabItem>
	<TabItem label="yarn">```bash yarn add vercel ```</TabItem>
	<TabItem label="npm">```bash npm i vercel ```</TabItem>
	<TabItem label="bun">```bash bun i vercel ```</TabItem>
</Tabs>
...
<Tabs>
	<TabItem label="pnpm">```bash pnpm i @vercel/analytics ```</TabItem>
	<TabItem label="yarn">```bash yarn add @vercel/analytics ```</TabItem>
	<TabItem label="npm">```bash npm i @vercel/analytics ```</TabItem>
	<TabItem label="bun">```bash bun i @vercel/analytics ```</TabItem>
</Tabs>

## Framework-specific setup

Select your framework below to see the specific integration instructions.
